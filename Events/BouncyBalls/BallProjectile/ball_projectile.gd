...
# To prevent flickering on clients' screens, only synchronize RigidBody parameters in this function.
# Flickering solution from: https://www.reddit.com/r/godot/comments/180ywzs/multiplayersynchronizer_and_rigidbody/
